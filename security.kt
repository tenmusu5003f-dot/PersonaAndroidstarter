  ...
  "modules": [
    {
      ...
      "version": "1.0.0",
      "files": [
        { "path": "scripts/prologue.script", "sha256": "aaaaaaaa...", "size": 1024 },
        { "path": "voices/aria.voice",       "sha256": "bbbbbbbb...", "size": 2048 }
      ]
    }
  ]
}
  ...
  "modules": [
    {
      ...
      "files": [
        {
          "path": "scripts/prologue.script",
          "sha256": "cccccccc...",
          "size": 1100,
          "url": "https://cdn.example.com/persona/core-assets/scripts/prologue.script"
        },
        {
          "path": "voices/aria.voice",
          "sha256": "dddddddd...",
          "size": 2100,
          "url": "https://cdn.example.com/persona/core-assets/voices/aria.voice"
        }
      ]
    }
  ]
...
class PersonaApp : Application() {
    override fun onCreate() {
        super.onCreate()
        com.persona.androidstarter.security.SecurityHub.init(this)
        ...
        kotlinx.coroutines.GlobalScope.launch {
            ...
            if (ok) {
                // 進捗通知をBusに投げる（任意）
                val payload = """{"install":"ok","ts":${System.currentTimeMillis()}}""".toByteArray()
                val env = com.persona.androidstarter.security.SecureChannel
                    .wrap("system/install/status", payload)
                core.bus.PersonaBus.dispatch(env)
            }
        }
...
lifecycleScope.launch {
    core.bus.PersonaBus.subscribe("system/install/status").collect { bytes ->
        val msg = String(bytes)
        // UIに「セットアップ完了」を表示するなど
        android.util.Log.i("InstallEvent", msg)
    }
}
